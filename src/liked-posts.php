...
<body>
    <div class="flex max-w-7xl mx-auto items-start">
        ...
        <div class="w-2/4">
            <?php
                if(isset($_SESSION['userid'])) {
                    $sql = "SELECT liked_posts.liked_at, users.username, users.profile_picture, posts.user, posts.message, posts.photo, posts.created_at, posts.id 
                            FROM liked_posts 
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        ...
                        <div class='p-3'>
                            ...
                            <p class='text-center'>It looks like you haven't liked any posts yet.<br>Start exploring and liking posts to see them here.<br>Have fun exploring!</p>
                        </div>
                        ";
                    }
                } else {
                    ...
                    <div class='p-3'>
                        <h1 class='text-5xl font-bold mb-3 text-center'>Oops!</h1>
                        <p class='text-center'>It looks like you cannot view liked posts because you are not logged in.<br>Please log in to your account to access this feature.<br>Happy browsing!</p>
                    </div>
                    ";
                }
            ?>
